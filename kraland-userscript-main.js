...
.form-control:focus {
  box-shadow: 0 0 0 .18rem rgb(164,18,13,0.22);
...
input[type="radio"]:focus {
  outline: none;
  box-shadow: 0 0 0 .12rem rgb(164,18,13,0.18) !important;
}
...
/* Alerts - info variant */
.alert.alert-info {
  background-color: rgb(164,18,13,0.06);
  border-color: rgb(164,18,13,0.14);
  color: var(--kr-text);
}
...
a.btn-primary {
  ...
  box-shadow: 0 6px 18px rgb(165,18,13,0.12);
}
...
html.kr-theme-variant-empire-brun-dark .c1  { background-color: rgb(255, 128, 128, 0.2); }
html.kr-theme-variant-empire-brun-dark .c2  { background-color: rgb(170, 112, 0, 0.3); }
html.kr-theme-variant-empire-brun-dark .c3  { background-color: rgb(255, 255, 128, 0.15); }
html.kr-theme-variant-empire-brun-dark .c4  { background-color: rgb(128, 128, 255, 0.2); }
html.kr-theme-variant-empire-brun-dark .c5  { background-color: rgb(128, 255, 128, 0.15); }
html.kr-theme-variant-empire-brun-dark .c6  { background-color: rgb(204, 128, 255, 0.2); }
html.kr-theme-variant-empire-brun-dark .c7  { background-color: rgb(170, 170, 170, 0.2); }
html.kr-theme-variant-empire-brun-dark .c8  { background-color: rgb(115, 151, 115, 0.2); }
html.kr-theme-variant-empire-brun-dark .c9  { background-color: rgb(170, 170, 68, 0.2); }
html.kr-theme-variant-empire-brun-dark .c10 { background-color: rgb(204, 255, 255, 0.15); }
